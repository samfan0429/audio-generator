...
Generator::Generator(double freq, double amp, std::string type, int time)
{
    // std::cout << "WORKING?" << std::endl;
    this->initVariables(freq, amp, type, time);
}
...
void Generator::initVariables(double freq, double amp, std::string type, int time)
{
    // std::cout << "It fucking works wtf" << std::endl;
    int duration = 44100/time*4;
    // std::cout << "It fucking works wtf" << std::endl;
